        ...
        <div className={styles.inner}>
          ...
          <div className={styles.left}>
            ...
            <p className={`${styles.body} reveal reveal-delay-2`}>
              A distinguished academic trajectory spanning four decades, from foundational teacher training through to the pinnacle of doctoral research in Religious Ethics.
            </p>
          </div>
