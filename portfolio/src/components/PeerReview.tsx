        ...
        <div className={styles.grid}>
          ...
          <div className={styles.heading}>
            ...
            <p className={`${styles.headingBody} reveal reveal-delay-2`}>
              Contributing to the integrity of academic discourse by reviewing manuscripts for leading journals in religious studies, pastoral counselling, and peacebuilding.
            </p>
