          ...
          <div className={styles.ctaInner}>
            <div>
              ...
              <p className={styles.ctaBody}>
                Research partnerships, speaking engagements, pastoral consultations, and academic collaborations welcome.
              </p>
            </div>
        ...
        <div className="container">
          <div className={styles.grid}>
            ...
            <div className={styles.identity}>
              <h3 className={styles.name}>Dr. Mary Abiola Adeoye</h3>
          ...
          <div className={styles.bottom}>
            <p className={styles.bottomText}>
              © {new Date().getFullYear()} Dr. Mary Abiola Adeoye. All rights reserved.
            </p>
            <p className={styles.bottomText}>
              {personal.address}
            </p>
