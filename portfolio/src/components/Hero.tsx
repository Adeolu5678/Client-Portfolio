...
export default function Hero() {
  ...
  return (
    <section id="hero" className={styles.hero} ref={containerRef}>
      ...
      <div className={styles.bgText} aria-hidden>ADEOYE</div>
      ...
      <div className={styles.container}>
        ...
        <div className={styles.left}>
          ...
          <h1 className={styles.name} data-hero style={{ opacity: 0, transform: "translateY(30px)", transition: "all 0.9s cubic-bezier(0.16,1,0.3,1)" }}>
            <span className={styles.nameFirst}>Mary</span>
            <span className={styles.nameFirst}>Abiola</span>
            <span className={styles.nameLast}>Adeoye</span>
          </h1>
        ...
        <div className={styles.right}>
          ...
          >
            ...
            <p>
              Appraising counselling techniques for young people through the lens of Religious Ethics — shaping both the church and the academy.
            </p>
          </div>
